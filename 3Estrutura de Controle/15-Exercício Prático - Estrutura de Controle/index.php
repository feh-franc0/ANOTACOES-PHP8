 ...
 * * IF, Switch, Match
 * TODO: Crie três variáveis, $autorizado, $admin e $nome . Avalie se a variável $autorizado for igual a verdadeiro e $admin igual a verdadeiro escreva na tela: "Área Administrativa, $nome, Bem vindo!"
 * 
 ...
 * TODO: Este contador presica armazenar uma instruçao HTML dentro de uma variável string $option com a seguinte estrutura: '<option value="$valor">$valor</option>'.
 ...
 * TODO: Crie um arquivo chamado exercicio-03-b.php incluindo de forma obrigatória o arquivo anterior, e ccrie uma condição, para caso o IDIOMA seja "pt-BR" e o LOCALE seja "America/Sao_Paulo" Imprima na tela: Idioma: Português, Fuso Horário: -3:00
 * 
 */